        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default" style="margin-top:9px;">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('candidate.login.submit') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" dir="ltr" type="email" class="form-control" name="email" value="{{ old('email') }}" required autofocus>
