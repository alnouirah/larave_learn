        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default" style="margin-top: 9px;">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('CandidateRegister') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input dir="ltr"  id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input dir="ltr"  id="password" type="password" class="form-control" name="password" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input dir="ltr"  id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
